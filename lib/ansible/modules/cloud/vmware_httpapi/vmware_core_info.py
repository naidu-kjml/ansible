...
from ansible.module_utils.vmware.VmwareRestModule import VmwareRestModule


def main():
    argument_spec = VmwareRestModule.rest_argument_spec(use_filters=True)
    ...
    module.submit(url=url, key=object_type)
